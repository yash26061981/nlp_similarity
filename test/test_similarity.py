...
#sys.path.insert(1, '/nlp/nlp_similarity/nlpsim_main')
import nlpsim
from nlpsim.nlpsim_main.similarity import GetSimilarity
...
#localhost:5000/nlpsim_main?s1="Relative pronoun"&s2="[pronoun]"&s3=''&s4="[Indefinite pronoun, Distributive pronoun, Reflexive pronoun]"